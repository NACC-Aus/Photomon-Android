 ...
 * Spinner come from the {@link Adapter} associated with this view.
 * 
 * <p>
 * See the <a href="{@docRoot}resources/tutorials/views/hello-spinner.html">Spinner tutorial</a>.
 * </p>
 * 
...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
     ...
     * 
     * @param context
     *            The Context the view is running in, through which it can access the current theme,
     *            resources, etc.
     * @param attrs
     *            The attributes of the XML tag that is inflating the view.
     * @param defStyle
     *            The default style to apply to this view. If 0, no style will be applied (beyond
     ...
     * 
     * @param delta
     *            Change in the selected position. +1 moves selection is moving to the right, so
